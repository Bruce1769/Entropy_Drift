...
#SBATCH --mem=256G
#SBATCH --time=2:00:00
#SBATCH --output=/gpfs/home/cpt/zhaodongwu20/Entropy_Drift/logs/test_aime25_1_%j.out
#SBATCH --error=/gpfs/home/cpt/zhaodongwu20/Entropy_Drift/logs/test_aime25_1_%j.err
...
DATASET=aime
OUTPUT_DIR=output/test_aime25_1_e0.6

echo "Testing aime25_1 only with entropy_threshold=0.6"
