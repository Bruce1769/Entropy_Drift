#!/usr/bin/env bash
#SBATCH --job-name=test_aime25_14
...
#SBATCH --mem=256G
#SBATCH --time=2:00:00
#SBATCH --output=/gpfs/home/cpt/zhaodongwu20/Entropy_Drift/logs/test_aime25_14_%j.out
#SBATCH --error=/gpfs/home/cpt/zhaodongwu20/Entropy_Drift/logs/test_aime25_14_%j.err
...
DATASET=aime
OUTPUT_DIR=output/test_aime25_14_e0.6

echo "Testing aime25_14 only with entropy_threshold=0.6"
